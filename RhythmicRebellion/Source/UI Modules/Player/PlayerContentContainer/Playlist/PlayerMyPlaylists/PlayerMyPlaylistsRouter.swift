...
final class DefaultPlayerMyPlaylistsRouter:  PlayerMyPlaylistsRouter, FlowRouterSegueCompatible {
    ...
    func start(controller: PlayerMyPlaylistsViewController) {
        ...
        let vm = PlayerMyPlaylistsControllerViewModel(router: self, application : dependencies.application, player: self.dependencies.player, restApiService: self.dependencies.restApiService)
