...
final class DefaultPlayerFollowingRouter:  PlayerFollowingRouter, FlowRouterSegueCompatible {
    ...
    func prepare(for destination: DefaultPlayerFollowingRouter.SegueActions, segue: UIStoryboardSegue) {
        switch destination {
