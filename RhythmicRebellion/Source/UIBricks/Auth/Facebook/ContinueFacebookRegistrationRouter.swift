//
//  ContinueFacebookRegistrationRouter.swift
//  RhythmicRebellion
//
...
struct ContinueFacebookRegistrationRouter : MVVM_Router {
    
    var owner: UIViewController {
        return _owner!
    }
    
    weak private var _owner: ContinueFacebookRegistrationRouter.T?
    init(owner: ContinueFacebookRegistrationRouter.T) {
        self._owner = owner
    }
